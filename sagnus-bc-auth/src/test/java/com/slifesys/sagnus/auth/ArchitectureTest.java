...
/**
 * Regras de arquitetura para BC Auth (DDD + Hexagonal).
 * 
 * Enforce ADR-0001: Domain puro, camadas isoladas, sem acoplamento entre BCs.
 */
@AnalyzeClasses(packages = "com.slifesys.sagnus.auth")
public class ArchitectureTest {

    private static final String BASE = "com.slifesys.sagnus.auth..";
