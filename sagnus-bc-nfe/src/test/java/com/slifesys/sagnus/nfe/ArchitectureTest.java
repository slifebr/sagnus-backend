...
/**
 * Regras de arquitetura para BC NFe (DDD + Hexagonal).
 * 
 * Enforce ADR-0001: Domain puro, camadas isoladas, sem acoplamento entre BCs.
 * Enforce ADR-0012: CalculadoraIvaService em domain/service.
 */
@AnalyzeClasses(packages = "com.slifesys.sagnus.nfe")
public class ArchitectureTest {

    private static final String BASE = "com.slifesys.sagnus.nfe..";
    ...
    @Test
    void sanityCheck() {
        // Just to verify if custom runner is active or if Jupiter Engine picks this up
    }
